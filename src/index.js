...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0__);\n// Imports\n\nvar ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(false);\n// Module\n___CSS_LOADER_EXPORT___.push([module.i, \"html{font-family:\\\"Fira Code\\\"}*{margin:0;padding:0;box-sizing:border-box}.header{display:flex;flex-direction:column;align-items:center}.header .nav{min-height:5vh;width:100%;display:flex}.header .nav .brand{display:inline-block;width:30%;padding:10px;text-align:left}.header .nav .nav-list{display:flex;justify-content:space-around;align-items:center;width:70%}.header .nav .nav-list .nav-item{cursor:pointer;list-style:none}.header .nav .nav-menu{cursor:pointer;display:none;position:absolute;right:20px;top:10px}.header .nav .nav-menu .menu-item{width:20px;height:3px;background:violet;margin:2px}.header .sidebar{display:none;position:absolute;color:#000;border:2px solid green;background:#fff;top:10vh;z-index:999;height:80vh;width:90vw;padding:5vw 10vw;transition:.5s ease-in-out}.header .sidebar .sidebar-close{text-align:right}.header .sidebar .sidebar-list .sidebar-item{list-style:none;margin:20px 0;font-size:larger}.header .sidebar.show{display:block}.main{min-height:85vh;background:#1f1a1a;color:#fff;display:flex;flex-direction:column;justify-content:space-around;align-items:center}.footer{min-height:3vh;text-align:center}@media screen and (max-width: 500px){.header .nav .brand{width:70vw}.header .nav .nav-list{display:none}.header .nav .nav-menu{display:inline-block}}@keyframes sidebaranimate{0%{display:none}100%{display:block}}\", \"\"]);\n// Exports\n/* harmony default export */ __webpack_exports__[\"default\"] = (___CSS_LOADER_EXPORT___);\n\n\n//# sourceURL=webpack:///./assets/styles/styles.scss?./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js");
